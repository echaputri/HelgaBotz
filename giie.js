...
giie.updatePresence(from, Presence.recording)
   ...
   const sotoy = [
     ...
     case "5b017c6ac1fb953c7bd21034d2fca5fad75ef2da4c3b2c2877ef49fa544e74bf":
       ...
       menu = `*_➪ ɴᴏᴛɪᴄᴇ :_*
_ᴀssᴀʟᴀᴍᴜᴀʟᴀɪᴋᴜᴍ_ _${pushname}_ _ᴊɪᴋᴀ ʙᴜᴛᴛᴏɴ ᴅɪ ʙᴀᴡᴀʜ ᴛɪᴅᴀᴋ ʙᴇʀғᴜɴɢsɪ sɪʟᴀʜᴋᴀɴ ᴋᴇᴛɪᴋ_ _${prefix}ᴀʟʟᴍᴇɴᴜ_
_ᴛᴇʀɪᴍᴀᴋᴀsɪʜ_
...
- ᴅᴀʏ : ${week} ${weton}
- ᴅᴀᴛᴇ : ${calender}`
sendButLocation(from, `${menu}`, `${uwu}☕︎ɢɪᴏɴᴏᴠᴀ${uwu}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}command`,buttonText:{displayText:'🅼︎🅴︎🅽︎🆄︎'},type:1},{buttonId:`${prefix}owner`,buttonText:{displayText:'🅲︎🆁︎🅴︎🅰︎🆃︎🅾︎🆁︎'},type:1},{buttonId:`${prefix}script`,buttonText:{displayText:'🅸︎🅽︎🆂︎🆃︎🅰︎🅶︎🆁︎🅰︎🅼︎'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
case 'allmenu':
        ptod = "6289654560615@s.whatsapp.net"
        stod = `${sender}`
...
Giliran = @${tty.player1.split('@')[0]}`
 giie.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     giie.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *𝗠𝗔𝗔𝗙 𝗘𝗥𝗥𝗢𝗥 𝗧𝗘𝗥𝗝𝗔𝗗𝗜* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Bitch Boot",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./thub.jpg'),sourceUrl:"https://instagram.com/giiexsala"}}})
	}
    }
    }
    }
